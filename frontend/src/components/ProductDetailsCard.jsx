...
const ProductDetailCard = () => {
  ...
  if (!product) {
    return <div className="text-center mt-10 text-amber-600 font-semibold">Product not listed</div>;
  }
  ...
  return (
    <div className="w-[95%] md:w-4/5 lg:w-2/3 xl:w-1/2 mx-auto my-12 bg-white shadow-xl rounded-2xl p-8 space-y-6">
      ...
      <p className="flex items-center gap-1 text-sm text-gray-600">
        ...
        <span className="text-gray-700 font-medium">{product.rating || "4.7"}/5</span>
      </p>
      ...
      <div className="flex gap-4 mt-6">
        <button className="flex-1 py-2 bg-amber-600 text-white rounded-lg font-semibold hover:bg-amber-700 transition">
          Add to Cart
        </button>
        <button className="flex-1 py-2 bg-white border border-amber-600 text-amber-600 rounded-lg font-semibold hover:bg-amber-100 transition">
          Buy Now
        </button>
      </div>
