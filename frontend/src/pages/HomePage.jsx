        ...
        <div className="min-h-screen bg-gradient-to-br from-white to-amber-50 text-gray-800">
          ...
          <section className="py-16 bg-amber-100 text-center px-6">
            ...
            <p className="text-gray-700 mb-6">
              Join Desi Etsy to showcase your handmade creations and reach
              customers across the country.
            </p>
            <Link to="/register">
              <button className="px-8 py-3 rounded-full bg-amber-500 text-white font-semibold hover:bg-amber-600 transition">
                Register as Seller
              </button>
            </Link>
          </section>
